 ...
 */
export default function Voice(text,tok) {
	...
	if(!tok){
		tok = '24.8c55f422b8311bd1f3347e22eadb62a8.2592000.1607152434.282335-22912187'
	}
    var param =   {
						 tex: text,
						 tok: tok,
        ...
        if (xhr.readyState == 4) {
            ...
            if (xhr.status == 200) {
                if (xhr.response.type === 'audio/mp3') {
					...
					music.src=  URL.createObjectURL(xhr.response); //选择播放的音频
					music.play(); //执行播放
